...
/**
 * Servlet implementation class TransactionSellServlet
 */
public class TransactionSellServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			String[] msg = proxy.sell(loginCookie.getValue());
			if(msg == null){
			...
			for(int i=0; i< msg.length; i++){
				...
				String textToDisplay = m[1] + " : "+ m[2] + " Purchased by " + m[0] + ".<br/> Number of items bought is " + m[3] + " on " + m[5] + ":"+ m[6] + ":" + m[7].substring(0, 2) + "<br/><br/>";
			...
			PrintWriter out = response.getWriter();
			out.println("<html><body bgcolor=\"#E6E6FA\">There are no items to show - You have sold nothing");
